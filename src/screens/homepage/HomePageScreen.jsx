    ...
    return (
        <>
            ...
            <div id="container">
                ...
                <a id="logoText" href="https://github.com/timbslr">Tim Bslr</a>
                <img id="logoLeftArrowImage" src={logoLeftArrow} alt="Left side of the TimBslr logo"/>
                <img id="logoRightArrowImage" src={logoRightArrow} alt="Right side of the TimBslr logo"/>
            </div>
        </>
    );
}
